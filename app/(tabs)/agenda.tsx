...
export default function AgendaScreen() {
  ...
  const calendarDays = useMemo<(number | null)[]>(() => {
    ...
    while (days.length < 42) days.push(null); // altijd 6 rijen
    return days;
  }, [currentDate]);
...
const styles = StyleSheet.create({
  ...
  calendarGrid: { flexDirection: 'row', flexWrap: 'wrap' as const, justifyContent: 'flex-start' },
  // exact 1/7 breedte; geen padding op de buitenste cel -> geen wrap van zaterdag
