...
export default function DhikrScreen() {
  ...
  return (
    <>
            ...
            <View style={styles.customRoutinesList}>
              {routines.map((r: any) => (
                <View key={r.id} style={styles.customRoutineCard}>
                  <TouchableOpacity style={styles.customRoutineMain} onPress={() => { startRoutine(r.id); setShowCounter(true); }} activeOpacity={0.85}>
      ...
      <Modal visible={showCounter} animationType="slide" presentationStyle="fullScreen" onRequestClose={() => setShowCounter(false)}>
        <View style={styles.counterContainer}>
          <TouchableOpacity style={styles.counterCloseButton} onPress={() => setShowCounter(false)}>
          ...
          {activeRoutine && currentDhikr && (
            <View style={styles.counterContent}>
              ...
              <View style={styles.counterControlsRow}>
                <TouchableOpacity style={[styles.smallCtrlBtn, { backgroundColor: '#ffffff22', borderColor: '#ffffff40' }]} onPress={() => { resetRoutine(); }}>
              ...
              <View style={styles.progressContainer}>
                ...
                <Text style={styles.progressText}>
                  {currentDhikrIndex + 1} / {activeRoutine.dhikrList.length} • {currentCount} / {currentTarget}
                </Text>
              </View>
